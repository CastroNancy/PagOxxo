...
<meta charset="UTF-8">
  ...
  <title>Oxxo Paseos del alba </title>
  <style>
table {
...
<body><center>
<br><h1> Oxxo Paseos del alba</h1><br>
    <table  class="tabla" >
        <thead>
            <tr>
                <th > Id sucursal</th>
        ...
        <tbody>
            <?php
            $sucursa = array(
                array(02,"Paseos del Alba 8411, 32696 Cd Juárez, Chih. ",
                "7a.m.–11p.m","53","ciel","Oxxo Paseos del alba","Cd Juarez","7 dias a la semana")
            );
