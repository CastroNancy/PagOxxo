...
<br><h1> Oxxo Granjero</h1><br>
    <table  class="tabla" >
        ...
        <tbody>
            <?php
            $sucursa = array(
                array(01,"Blvd. Zaragoza, Granjero, 32690 Cd Juárez, Chih.",
                "7a.m.–11p.m","76","sabritas","Oxxo Granjero","Cd Juarez","7 dias a la semana")
            );
