...
<br><h1> Oxxo Piña</h1><br>
    <table  class="tabla" >
        ...
        <tbody>
            <?php
            $sucursa = array(
                array(03," C. Cártamo 6505, El Granjero, 32690 Cd Juárez, Chih.",
                "7a.m.–11p.m","567","gamesa","Oxxo Piña ","Cd Juarez","7 dias a la semana")
            );
