...
<br><h1> Oxxo  Camboya </h1><br>
    <table  class="tabla" >
        ...
        <tbody>
            <?php
            $sucursa = array(
                array(04," Blvd. Zaragoza 7250, Oasis, 32697 Cd Juárez, Chih. ",
                "7a.m.–11p.m"," 342","Sabritas","Oxxo Camboya  ","Cd Juarez","7 dias a la semana")
            );
