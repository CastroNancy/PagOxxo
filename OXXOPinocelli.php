...
<br><h1> Oxxo Pinocelli </h1><br>
    <table  class="tabla" >
        ...
        <tbody>
            <?php
            $sucursa = array(
                array(05,"Enrique Pinocelli 8251, Aerojuarez, 32696 Cd Juárez, Chih. ",
                "7a.m.–11p.m"," 67","Gamesa","Oxxo Pinocelli ","Cd Juarez","7 dias a la semana")
            );
