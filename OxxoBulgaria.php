...
<br><h1> Oxxo Bulgaria</h1><br>
    <table  class="tabla" >
        ...
        <tbody>
            <?php
            $sucursa = array(
                array(06,"Del Granjero 7090, Oasis, 32697 Cd Juárez, Chih.",
                "7a.m.–11p.m","06","barcel","Oxxo Bulgaria","Cd Juarez","7 dias a la semana")
            );
